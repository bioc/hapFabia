...
R> print("Statistics on haplotye cluster length in kbps:")
...
\texttt{filename\_mat.txt}, where the SNV annotation file
...
print("Statistics on haplotye cluster length in kbps:")
